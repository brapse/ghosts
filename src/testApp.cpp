...
void testApp::update(){
	...
	//printf("the frame rate is: %f, and it may be high or low \n", ofGetFrameRate());
	for(int i = 0; i < contourFinder.nBlobs; i++) cout << "center of blob " << i << "is X: " << blobs[i].centerX << "and Y: " << blobs[i].centerY << endl;
}
